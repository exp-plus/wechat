...
class OfficialAccount {
   ...
   */
  async generateQRCodeTicket(access_token, scene_id) {
    const { data } = await axios.post(`https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=${access_token}`, {
 ...
 */
  async code2WebAccessToken(code) {
